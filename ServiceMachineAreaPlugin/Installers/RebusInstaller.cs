        ...
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            if (connectionString.ToLower().Contains("convert zero datetime"))
            {
                Configure.With(new CastleWindsorContainerAdapter(container))
                    ...
                    .Transport(t => t.UseMySql(connectionStringOrConnectionOrConnectionStringName: connectionString, tableName: "Rebus", inputQueueName: "machinearea-input"))
                    .Options(o =>
                    {
            ...
            else
            {
                Configure.With(new CastleWindsorContainerAdapter(container))
                    .Logging(l => l.ColoredConsole())
                    .Transport(t => t.UseSqlServer(connectionString: connectionString, inputQueueName: "machinearea-input"))
